...
void PEnv(int socketstream ,string name){
    char* value=getenv(name.c_str());
    if(value!=NULL){
        cout<<value<<endl;
        string res=string(value)+"\n";
        write(socketstream,res.c_str() ,res.length());
    }
}
...
void ParseLine(int socketstream,string line){
